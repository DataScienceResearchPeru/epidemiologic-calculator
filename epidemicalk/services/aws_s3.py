...
from epidemicalk.services.image import generate_name_random, clean_base64, save_image
...
class AmazonS3Service(AmazonS3ServiceInterface):
    ...
    def __init__(self, app):
        ...
        self.client = session.client('s3', region_name=Settings.AWS_REGION, aws_access_key_id=access_key,
    ...
    def upload(self, image_base64: str):
        ...
        file_url = '%s/%s/%s' % (self.client.meta.endpoint_url, Settings.AWS_S3_BUCKET, name_file)
        os.remove(name_file)
        return file_url
